...
Aim: To develop a multi-processed solution to find a list of perfect numbers.
...
the number till which we check, and K, the number of processes, in that order respectively.
