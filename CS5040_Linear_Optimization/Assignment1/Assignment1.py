...
class BoundedLP:
    ...
    def find_correct_eps(self , A_untight , b_untight , point , dir):
        ...
        Since this is boundedLP, we do not need to worry, since we are bound to terminate
        and our epsilon will always support our theory of moving in +dir direction
        '''
        epsilon = 0
    ...
    def solve(self):
        '''
        main function to solve the Bounded Linear Programming problem
        '''
